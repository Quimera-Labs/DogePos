...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/Dogepos/Dogepos>";
    const std::string URL_WEBSITE = "<https://dogepos.com//>";
    ...
    return FormatParagraph(strprintf("Copyright (C) %i-%i The Bitcoin Core Developers", 2009, COPYRIGHT_YEAR)) + "\n" +
           ...
           "\n" +
           FormatParagraph(strprintf("Copyright (C) %i The DogePos Developers", 2025)) + "\n" +
           "\n" +
           FormatParagraph(strprintf(_("Please contribute if you find DogePos useful. "
