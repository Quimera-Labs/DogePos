...
const QString BITCOIN_IPC_PREFIX("dogepos:");
// BIP70 payment protocol messages
const char* BIP70_MESSAGE_PAYMENTACK = "PaymentACK";
const char* BIP70_MESSAGE_PAYMENTREQUEST = "PaymentRequest";
// BIP71 payment protocol media types
const char* BIP71_MIMETYPE_PAYMENT = "application/dogepos-payment";
const char* BIP71_MIMETYPE_PAYMENTACK = "application/dogepos-paymentack";
const char* BIP71_MIMETYPE_PAYMENTREQUEST = "application/dogepos-paymentrequest";
    ...
    optionsModel(0)
{
    ...
    // on Mac: sent when you click dogepos: links
...
//
// OSX-specific way of handling dogepos: URIs and PaymentRequest mime types.
...
void PaymentServer::initNetManager()
{
    ...
    // netManager is used to fetch paymentrequests given in dogepos: URIs
