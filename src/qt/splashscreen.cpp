    ...
    QWidget(0, f), curAlignment(0)
{
    ...
    QString copyrightTextDogePos   = QChar(0xA9)+QString(" %1 ").arg(2025) + QString("The DogePos Developers");
    ...
    QRect rectIcon(QPoint(-40,-110), QSize(430,430));
    ...
    // draw copyright stuff
    {
        ...
        pixPaint.drawText(x,y+30,copyrightTextDogePos);
    }
