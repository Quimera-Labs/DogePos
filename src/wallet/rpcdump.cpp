...
UniValue dumpprivkey(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() != 1)
        throw runtime_error(
            "dumpprivkey \"dogeposaddress\"\n"
            "\nReveals the private key corresponding to 'dogeposaddress'.\n"
            "Then the importprivkey can be used with this output\n"
            "\nArguments:\n"
            "1. \"dogeposaddress\"   (string, required) The dogepos address for the private key\n"
            "\nResult:\n"
